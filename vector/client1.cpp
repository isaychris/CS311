...
// Compiler:  g++
// File type: vstack client program
//===========================================================
...
int main()
{
	vstack postfixstack; // my stack object instance.
	...
	while (expression[i] != '\0') {
		...
		//exception cases.
		catch (vstack::Overflow) { // for too many elements on stack.
